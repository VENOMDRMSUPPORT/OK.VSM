...
namespace HyperVMManager.Services;
	...
	public sealed class VmBulkDetails
	{
		public Dictionary<string, int> CpuByVm { get; init; } = new Dictionary<string, int> ();

		public Dictionary<string, ulong> MemoryBytesByVm { get; init; } = new Dictionary<string, ulong> ();
